...
public:
    ...
    {
        cout << "Vehicle No.: " << count << endl;
    }
    ~Vehicle()
    {
        count--;
        cout << "No. of vehicles after destructing" << count << endl;
    }
};
